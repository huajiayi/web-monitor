package com.joey.monitor.common.aop;
...
public class GlobalExceptionHandler {
    ...
    public Response handleMethodArgumentNotValidException(HttpServletRequest request, BindException e) {
        var errorField = e.getFieldError().getField();
        var errorMsg = e.getBindingResult().getFieldError().getDefaultMessage();
